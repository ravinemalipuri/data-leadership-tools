...
export default function RaidForm() {
  ...
  // Derive risk score when impact + likelihood change
  useEffect(() => {
    ...
    <div className="form-page">
      <div className="form-card">
        <div className="form-header">
          <div>
            <h1 className="form-title">{isEdit ? 'Edit RAID Entry' : 'New RAID Entry'}</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-section">
            <label className="form-label">RAID Type <span className="required">*</span></label>
            <div className="type-buttons">
              {(['R', 'A', 'I', 'D'] as RaidType[]).map(t => (
                <button
                  key={t} type="button"
          ...
          <div className="form-grid">
            <div className="form-field full-width">
              ...
              <input
                ...
                placeholder="Brief title describing this RAID item"
              />
