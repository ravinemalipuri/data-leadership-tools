# Data & Analytics Platform Management Tools
...
| [raid-log](./raid-log/) | Full-stack RAID Log for Technical Programme Managers — track Risks, Assumptions, Issues, and Dependencies across enterprise data programmes (Data Mesh, MDM, SAP/Salesforce integrations). Risk scoring matrix, smart dashboard filters, Excel import/export, Docker-ready | v1.1 — Ready to use |
